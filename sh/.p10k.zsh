# Generated by Powerlevel10k configuration wizard on 2020-01-18 at 20:39 EST.
...
# dotted, no frame, lightest, compact, many icons, concise, transient_prompt,
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=81 # 81, 66, 109
  # Make the icon bold.
